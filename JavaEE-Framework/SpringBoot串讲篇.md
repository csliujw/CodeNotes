...
去spring官网找出boot需要的依赖，写入pom文件中 https://spring.io/guides/gs/spring-boot/
...
可以在application.properties中使用spring.profiles.active=xxx;
...
<body>
    <div th:text="${name}"></div><!-- 转义 无法识别<h1> -->
    <div th:utext="${name}"></div><!-- 不转义正常识别<h1> -->

    <h4 th:text="${temp}" th:each="temp:${arrays}"></h4>
</body>
</html>
```
