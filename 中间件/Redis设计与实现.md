...
![image-20220202180207563](img\image-20220202180207563.png)
...
![image-20220202180400328](img\image-20220202180400328.png)
...
- 假设现在有一个INTSET_ENC_INT16编码的整数集合，**集合中包含三个int16_t类型的元素**
    ...
    ![image-20220202180503966](img\image-20220202180503966.png)

    - 因为contents中的元素都是16位的，3个数组共占用空间48位，如下


![image-20220202180621098](img\image-20220202180621098.png)
...
![image-20220202180705372](img\image-20220202180705372.png)

- 将数组中的元素**类型改为int32_t**，并放入扩展后的contents中。最后添加新插入的元素。

![image-20220202180758892](img\image-20220202180758892.png)

![image-20220202180848739](img\image-20220202180848739.png)

![image-20220202180936602](img\image-20220202180936602.png)

![image-20220202181031326](img\image-20220202181031326.png)
...
![image-20220202181110708](img\image-20220202181110708.png)
...
![image-20220202181302198](img\image-20220202181302198.png)

删除 4294967295 后

![image-20220202181324217](img\image-20220202181324217.png)
