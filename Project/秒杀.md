...
- 使用 docker 安装 MQ
-  sudo docker pull rabbitmq:3-management 拉取镜像
-  sudo docker run  -e RABBITMQ_DEFAULT_USER=demo -e RABBITMQ_DEFAULT_PASS=123321  --name mq  --hostname mq1  -p 15672:15672 # 启动 rabbitmq
    - 15672 是用户管理端口
