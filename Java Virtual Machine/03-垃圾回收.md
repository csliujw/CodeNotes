...
<img src="jvm_image/G1_01.png" style="width:60%">
...
<img src="jvm_image/YoungCollection_01.png" style="width:60%">

新生代的垃圾回收会把幸存的对象，用 copy 算法复制到 S区。

<img src="jvm_image/YoungCollection_02.png" style="width:60%">

幸存区的对象比较多时，或幸存区的对象年龄超过阈值，S就触发垃圾回收，S区的一部分对象会晋升到老年代，不够年龄的会拷贝到另一个幸存取空间中去。

<img src="jvm_image/YoungCollection_03.png" style="width:60%">
...
<img src="jvm_image/YoungCollection+CM.png" style="width:60%">
...
<img src="jvm_image/MixedCollection.png" style="width:60%">
...
<img src="jvm_image/remark_01.png" style="width:60%">
...
<img src="jvm_image/remark_02.png" style="width:60%">
