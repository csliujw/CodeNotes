...
<img src="../pics/JavaStrengthen/jvm/thread_memory.png">

因为 t 线程要频繁从主内存中读取 run 的值，JIT 编译器会将 run 的值缓存至自己工作内存中的高速缓存中，减少对主存中 run 的访问，提高效率

<img src="../pics/JavaStrengthen/jvm/thread_cache.png">
...
![image-20210929151317385](jvm_image\image-20210929151317385.png)

<div style="text-align: center;">轻量级锁 CAS 操作之前堆栈于对象的状态</div>

![image-20210929151629324](jvm_image\image-20210929151629324.png)
