...
- 扫描堆中的对象，看是否能沿着以 GC Roots 对象为起点的引用链找到该对象，如果找不到，则表示可以回收。
...
- <b>卡精度</b>：每个记录精确到一块内存区域，该区域内有对象含有跨代指针。(一般用这个)
...
<span style="color:red"><b>Parallel GC</b></span>
